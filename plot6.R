...
ggplot(NEI1, aes(x=year, y=Emissions, group=fips, color=fips)) +geom_line() +labs(title="Comparison of Motor Vehicle Emissions - Baltimore City vs Los Angeles", x="Year", y="Total Emissions")
dev.off()